      ...
      <div className={styles.sections}>
        <div className={styles.employerSection}>
          <div className={styles.employerRow}>
            <h3>For Employers</h3>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" fill="none" className={styles.icons}>
          ...
          <p>Explore pre-verified talent and hire faster with AI-powered matching</p>
        </div>
        <div className={styles.recruiterSection}>
          ...
          <p>Explore opportunities that match your skills and career goals instantly</p>
        </div>
      </div>
    </div>
  );
