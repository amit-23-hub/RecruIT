      ...
      <div className={styles.menuItem}>
        <div className={styles.logo}>
          ...
          >
            ...
            />
            <path
              d="M14.8333 19.9191C14.8333 16.9028 17.2784 14.4577 20.2947 14.4577C23.3109 14.4577 25.7561 16.9028 25.7561 19.9191V20.2344C25.7561 23.2507 23.3109 25.6958 20.2947 25.6958C17.2784 25.6958 14.8333 23.2507 14.8333 20.2344V19.9191Z"
              fill="#B7ACAC"
            />
            <path
            ...
            />
            <path
              d="M0 19.9191C0 16.9028 2.44516 14.4577 5.46142 14.4577C8.47768 14.4577 10.9228 16.9028 10.9228 19.9191V20.2344C10.9228 23.2507 8.47768 25.6958 5.46142 25.6958C2.44516 25.6958 0 23.2507 0 20.2344V19.9191Z"
              fill="#B7ACAC"
            />
          </svg>
        </div>
      ...
      <div className={styles.menuItem}>
        <div className={styles.icon}>
          ...
          >
            ...
            />
            <path
              d="M15 18H8.99996M21.194 16.793C20.844 19.273 20.669 20.514 19.772 21.257C18.875 22 17.552 22 14.905 22H9.09496C6.44896 22 5.12496 22 4.22796 21.257C3.33096 20.514 3.15596 19.274 2.80596 16.793L2.38396 13.793C1.93696 10.629 1.71396 9.048 2.66196 8.023C3.60996 7 5.29796 7 8.67196 7H15.328C18.702 7 20.39 7 21.338 8.024C22.087 8.833 22.105 9.99 21.859 12"
              stroke="#A0AEC0"
              stroke-width="1.5"
