...
import img from '../../../assets/recruiterFeature1.png';
    ...
    <div className={styles.mobileContainer}>
      ...
      <div className={styles.contentSection}>
        <div className={styles.headerContent}>
          ...
          <p>Streamline your hiring process, uncover the best candidates, and
          make smarter decisions with our cutting-edge AI tools.</p>
